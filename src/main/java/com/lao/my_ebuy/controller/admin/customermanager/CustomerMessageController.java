package com.lao.my_ebuy.controller.admin.customermanager;
...
public class CustomerMessageController {
    ...
    public String queryCustomerPage(HttpServletRequest request, Page<Customer> page){
        Page<Customer> customers = customerService.queryCustomerPage(page);
     ...
     * @return String
     */
    @RequestMapping(value = "/productSearchResult")
